module.exports = {
    ...
    run: async ({ client, message }) => {
        ...
        if (player.rock) {
            message.channel.createMessage({ content: `${client.emote.removingFilter} Removing rock filter, please wait...` });
            player.rock = !player.rock;
        } else {
            message.channel.createMessage({ content: `${client.emote.ok} Activating rock filter, please wait...` });
            player.rock = !player.rock;
        }
        return null;
    },
