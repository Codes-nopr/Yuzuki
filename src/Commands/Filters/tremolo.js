module.exports = {
    ...
    run: async ({ client, message }) => {
        ...
        if (player.tremolo) {
            message.channel.createMessage({ content: `${client.emote.removingFilter} Removing tremolo filter, please wait...` });
            player.tremolo = !player.tremolo;
        } else {
            message.channel.createMessage({ content: `${client.emote.ok} Activating tremolo filter, please wait...` });
            player.tremolo = !player.tremolo;
        }
        return null;
    },
