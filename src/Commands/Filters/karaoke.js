module.exports = {
    ...
    run: async ({ client, message }) => {
        ...
        if (player.karaoke) {
            message.channel.createMessage({ content: `${client.emote.removingFilter} Removing karaoke filter, please wait...` });
            player.karaoke = !player.karaoke;
        } else {
            message.channel.createMessage({ content: `${client.emote.ok} Activating karaoke filter, please wait...` });
            player.karaoke = !player.karaoke;
        }
        return null;
    },
