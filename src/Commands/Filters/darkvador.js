module.exports = {
    ...
    run: async ({ client, message }) => {
        ...
        if (player.darkvador) {
            message.channel.createMessage({ content: `${client.emote.removingFilter} Removing darkvador filter, please wait...` });
            player.darkvador = !player.darkvador;
        } else {
            message.channel.createMessage({ content: `${client.emote.ok} Activating darkvador filter, please wait...` });
            player.darkvador = !player.darkvador;
        }
        return null;
    },
