module.exports = {
    ...
    run: async ({ client, message }) => {
        ...
        if (player.vibrato) {
            message.channel.createMessage({ content: `${client.emote.removingFilter} Removing vibrato filter, please wait...` });
            player.vibrato = !player.vibrato;
        } else {
            message.channel.createMessage({ content: `${client.emote.ok} Activating vibrato filter, please wait...` });
            player.vibrato = !player.vibrato;
        }
        return null;
    },
