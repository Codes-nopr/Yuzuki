module.exports = {
    ...
    run: async ({ client, message }) => {
        ...
        if (player.highvoice) {
            message.channel.createMessage({ content: `${client.emote.removingFilter} Removing highvoice filter, please wait...` });
            player.highvoice = !player.highvoice;
        } else {
            message.channel.createMessage({ content: `${client.emote.ok} Activating highvoice filter, please wait...` });
            player.highvoice = !player.highvoice;
        }
        return null;
    },
