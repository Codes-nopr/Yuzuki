module.exports = {
    ...
    run: async ({ client, message }) => {
        ...
        if (player.highfull) {
            message.channel.createMessage({ content: `${client.emote.removingFilter} Removing highfull filter, please wait...` });
            player.highfull = !player.highfull;
        } else {
            message.channel.createMessage({ content: `${client.emote.ok} Activating highfull filter, please wait...` });
            player.highfull = !player.highfull;
        }
        return null;
    },
