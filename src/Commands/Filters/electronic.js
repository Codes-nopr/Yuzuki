module.exports = {
    ...
    run: async ({ client, message }) => {
        ...
        if (player.electronic) {
            message.channel.createMessage({ content: `${client.emote.removingFilter} Removing electronic filter, please wait...` });
            player.electronic = !player.electronic;
        } else {
            message.channel.createMessage({ content: `${client.emote.ok} Activating electronic filter, please wait...` });
            player.electronic = !player.electronic;
        }
        return null;
    },
