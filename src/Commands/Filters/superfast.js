module.exports = {
    ...
    run: async ({ client, message }) => {
        ...
        if (player.superfast) {
            message.channel.createMessage({ content: `${client.emote.removingFilter} Removing superfast filter, please wait...` });
            player.superfast = !player.superfast;
        } else {
            message.channel.createMessage({ content: `${client.emote.ok} Activating superfast filter, please wait...` });
            player.superfast = !player.superfast;
        }
        return null;
    },
