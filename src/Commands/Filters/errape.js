module.exports = {
    ...
    run: async ({ client, message }) => {
        ...
        if (player.errape) {
            message.channel.createMessage({ content: `${client.emote.removingFilter} Removing errape filter, please wait...` });
            player.errape = !player.errape;
        } else {
            message.channel.createMessage({ content: `${client.emote.ok} Activating errape filter, please wait...` });
            player.errape = !player.errape;
        }
        return null;
    },
