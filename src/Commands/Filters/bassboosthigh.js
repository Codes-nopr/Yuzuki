module.exports = {
    ...
    run: async ({ client, message }) => {
        ...
        if (player.bassboosthigh) {
            message.channel.createMessage({ content: `${client.emote.removingFilter} Removing bassboosthigh filter, please wait...` });
            player.bassboosthigh = !player.bassboosthigh;
        } else {
            message.channel.createMessage({ content: `${client.emote.ok} Activating bassboosthigh filter, please wait...` });
            player.bassboosthigh = !player.bassboosthigh;
        }
        return null;
    },
