module.exports = {
    ...
    run: async ({ client, message }) => {
        ...
        if (player.vaporewave) {
            message.channel.createMessage({ content: `${client.emote.removingFilter} Removing vaporewave filter, please wait...` });
            player.vaporewave = !player.vaporewave;
        } else {
            message.channel.createMessage({ content: `${client.emote.ok} Activating vaporewave filter, please wait...` });
            player.vaporewave = !player.vaporewave;
        }
        return null;
    },
