module.exports = {
    ...
    run: async ({ client, message }) => {
        ...
        if (player.radio) {
            message.channel.createMessage({ content: `${client.emote.removingFilter} Removing radiomix filter, please wait...` });
            player.radio = !player.radio;
        } else {
            message.channel.createMessage({ content: `${client.emote.ok} Activating radiomix filter, please wait...` });
            player.radio = !player.radio;
        }
        return null;
    },
